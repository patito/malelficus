 ...
 */
void print_table_generic(tb_line* l, int line_size, int fit_on_screen, int has_header) {
...
void print_table_header(tb_header *h, int header_size, int fit_on_screen) {
  print_table_generic(h, header_size, fit_on_screen, 1);
}

void print_table_line(tb_line *l, int line_size, int fit_on_screen) {
  print_table_generic(l, line_size, fit_on_screen, 0);
}
